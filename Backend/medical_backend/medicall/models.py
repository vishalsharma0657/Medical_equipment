...
class Product(models.Model):
    ...
    product_image = models.CharField( max_length=12, default="")
    ...
    product_image1 = models.CharField( max_length=12, default="")
    product_image2 = models.CharField( max_length=12, default="")
    product_image3 = models.CharField( max_length=12, default="")
    def __str__(self):
